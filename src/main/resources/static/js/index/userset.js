...
let app = new Vue({
    ...
    methods: {
        ...
        get:function(){
            ...
            this.$http.get("http://www.lichuachua.com:8082/school/queryList", {
                params: {
                    accessToken: token
                }
            }).then(
        ...
        loadData:function(){
            let self=this;
            let token=document.querySelector('#token').value;
            this.$http.get("http://www.lichuachua.com:8082/academy/queryList", {
                params: {
                    accessToken: token
                }
            }).then(
        ...
        edit: function () {
            if (this.$refs.avatarInput.files.length !== 0) {
                ...
                this.$http.put('http://www.lichuachua.com:8082/user/updateAvatar/'+file,image,{
        ...
        form1:function(){
            ...
            this.$http.put('http://www.lichuachua.com:8082/user/infor',formData,{'Content-Type':'Multipart/form-data'}).then(
                function(res){
                    if(res.body.code==0){
